...
mod tests {
    ...
    fn masking_keeps_toml_valid_and_preserves_api_keys_type() {
        ...
        cfg.channels.wati = Some(crate::config::schema::WatiConfig {
            enabled: true,
        ...
        cfg.channels.feishu = Some(crate::config::schema::FeishuConfig {
            enabled: true,
        ...
        cfg.channels.email = Some(crate::channels::email_channel::EmailConfig {
    ...
    fn hydrate_config_for_save_restores_masked_secrets_and_paths() {
        ...
        current.channels.wati = Some(crate::config::schema::WatiConfig {
            enabled: true,
        ...
        current.channels.feishu = Some(crate::config::schema::FeishuConfig {
            enabled: true,
        ...
        current.channels.email = Some(crate::channels::email_channel::EmailConfig {
            imap_host: "imap.example.com".to_string(),
            imap_port: 993,
            imap_folder: "INBOX".to_string(),
            smtp_host: "smtp.example.com".to_string(),
